...
<section class="panel"><div class="table-wrap"><table><thead><tr><th>日時</th><th>操作者</th><th>操作</th><th>対象</th><th>変更内容</th></tr></thead><tbody><?php foreach($logs as $log): ?><tr><td><?= e($log['created_at']) ?></td><td><?= e($log['actor_name'] ?: '不明') ?></td><td><?= e($log['action']) ?></td><td><?= e($log['target_type']) ?> #<?= e($log['target_id']) ?></td><td><details><summary>表示</summary><pre><?= e($log['before_json']) ?>
→

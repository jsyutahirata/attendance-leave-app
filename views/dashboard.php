...
<div class="two-col">
  <section class="panel"><div class="section-head"><h2>直近の有給予定</h2><a href="<?= e(url('leave')) ?>">すべて見る</a></div>
    <?php if (!$upcoming): ?><p class="empty">登録済みの予定はありません。</p><?php else: ?><ul class="item-list"><?php foreach ($upcoming as $entry): ?><li><strong><?= e($entry['leave_date']) ?></strong><span><?= e(['full'=>'1日','am'=>'午前休','pm'=>'午後休'][$entry['leave_type']]) ?></span></li><?php endforeach; ?></ul><?php endif; ?>
  </section>
